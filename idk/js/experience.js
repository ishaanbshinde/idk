...
const experienceAnswers = {
    name: localStorage.getItem("experienceName") || "",
    q1: "",
    q2: "",
    q3: "",
    q4: "",
...
async function saveExperienceAnswers() {
    ...
    try {
        ...
        console.log(
            "Sending experience answers to backend..."
        );
        ...
        console.log(
            "✅ Experience answers saved successfully."
        );
